...
$ln(P\omega_1)) > ln(P(\omega_2)) + \frac{2 \mu}{\sigma}$
\\
The right-hand side of the inequality is the maximum of the right-hand side function above, achieved when $x = - \mu$
