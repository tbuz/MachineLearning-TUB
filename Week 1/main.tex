...
$\Leftrightarrow \frac{\not{-\not{1}}}{\not{16}}\cdot exp(\frac{-(x-\mu)}{6}) \cdot P(\omega_1) = \frac{\not{-\not{1}}}{\not{16}}\cdot exp(\frac{-(x+\mu)}{6}) \cdot P(\omega_2)$

$\Leftrightarrow \frac{|x-\mu|}{6} + ln(P(\omega_1)) = \frac{|x+\mu|}{6} + ln (P(\omega_2))$
...
$\Leftrightarrow ln(P(\omega_1)) - \frac{|x-\mu|}{6} > ln(P(\omega_2)) - \frac{|x+\mu|}{6}$

$\Leftrightarrow ln(P(\omega_1)) > ln(P(\omega_2)) - \frac{|x+\mu|}{6} + \frac{|x-\mu|}{6}$
...
$ln(P\omega_1)) > ln(P(\omega_")) + \frac{2 \mu}{6}$
...
$ln(P(\omega_1)) - \frac{x-\mu)^2}{26^2} = ln(P(\omega_2)) - \frac{(x+\mu)^2}{26^2}$ 
...
$\Leftrightarrow ln(P(\omega_1)) > ln(P(\omega_2)) - \frac{(x+\mu)^2}{26^2} + \frac{(x-\mu)^2}{26^2}$ \\

$\omega_1$ is selected $\forall x \in \mathbb{R}$ when: \\

$\mu = 0$ and  $P(\omega_1) > P(\omega_2)$ \\

Otherwise, $ln(P(\oemga_2)) - \frac{(x+\mu)^2}{26^2} + \frac{(x-\mu)^2}{26^2} \rightarrow \infty$
